...
plot.gene = function(gene, dataset = "TPM", filter = FALSE){
  ...
  ggsave(paste0("Output/pDC-Subsets_P2RY14-markers_", ifelse(filter, "Basal", "All"), ".pdf"), width = 10, height = 7)
  plot
}
...
(function.2("data1", "Timepoint", "P2RY14", "Treatment") / function.2("data2", "Timepoint", "P2RY14", "Treatment")) |
...
data.heat1 = data %>% 
  filter(Timepoint == "0hr" & Treatment == "MNP") %>%
...
as_ggplot(grid.grabExpr(draw(heat.1))) + 

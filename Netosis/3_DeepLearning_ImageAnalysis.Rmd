...
ggsave(paste0(folder, "Output/Classes_FlowChart.pdf"), width = 10, height = 5)

```

## Movie class transitions
```{r Movie class transitions}
library(magick)
...
print(animation)
image_write(animation, paste0(folder, "Movies/", "Netosis_Exp13_Merged_", "A4_", "1", ".gif"))

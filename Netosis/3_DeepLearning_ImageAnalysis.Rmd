...
data = fread(paste0(folder, "Classification/", filename))
class_pred_c = model_big_cleanup %>% predict(data_pred) %>%
  as.data.frame %>%
...
write.csv(class_pred_c, paste0(folder, "Classification/Netosis_", exp_name, "_CleanUpClassification.csv"), row.names = FALSE)
